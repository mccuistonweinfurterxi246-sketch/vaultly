...
const LetterGlitch: React.FC<LetterGlitchProps> = ({
  ...
  const fontSize = 14; // slightly smaller for a more refined look
  const charWidth = 9;
  const charHeight = 18;
  ...
  const containerStyle: React.CSSProperties = {
    ...
    width: '100%',
    height: '100%',
    backgroundColor: 'transparent', // transparent to show the app's background
    overflow: 'hidden'
  };
  ...
  const outerVignetteStyle: React.CSSProperties = {
    ...
    height: '100%',
    pointerEvents: 'none',
    background: 'radial-gradient(circle, rgba(0,0,0,0) 70%, var(--background) 100%)'
  };
